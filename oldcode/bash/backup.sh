...
# a list from /home/morris - this simplifies
# adding or removing files from the backup

tar -czf /mnt/acoustics/backup/$DATE.tgz\
--files-from=/home/morris/backup.list \
...
mkisofs -r -f -o /mnt/acoustics/backup/$DATE.iso \
/mnt/acoustics/backup/$DATE.tgz \
$HOME/backup/lists/$DATE.list
# more feedback
